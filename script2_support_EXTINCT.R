...
# Write to CSV file
write.csv(combined_df, file = "../Dataset_R_q4_09-25_shared_extinct.csv", row.names = FALSE)
...
View(all_unique_df)
# Save as CSV
write.csv(all_unique_df, "../Dataset_R_q4_09-25_unique_extinct.csv", row.names = FALSE)
